...
def advection_scalar(  # noqa: C901 ignores function complexity, should revisit
    scalar,
    par_u,
    par_v,
    x,
    ...
    if meridional is True:
        ...
        for i in range(1, len(sep_m)):
            ...
            SF_m[i] = np.nanmean((adv_roll - adv) * (s_roll - s))
    ...
    if zonal is True:
        ...
        for i in range(1, len(sep_z)):
            ...
            SF_z[i] = np.nanmean((adv_roll - adv) * (s_roll - s))
